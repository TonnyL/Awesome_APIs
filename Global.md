...
+ [Email](#email)
+ [Fitness&Wearables](#fitnesswearables)
+ [Games](#games)
+ [Images](#images)
+ [IoT](#iot)
...
+ [Slack](https://api.slack.com/) - Slack brings all your communication together in one place. It's real-time messaging, archiving and search for modern teams.
...
+ [Duolingo(Unofficial)](https://github.com/KartikTalwar/Duolingo) - Access to [duolingo.com](https://www.duolingo.com/)'s data. #Unofficial
