...
### 游戏
+ [暴雪](https://dev.battle.net/) - Battle.net is an online video game Web site that features a collection of games developed by Blizzard Entertainment. The available Battle.net APIs include D3, WoW, SC2, Community APIs, and Game Data APIs.
+ [部落冲突](https://developer.clashofclans.com/#/) - 部落冲突 API 提供了接近实时的游戏相关数据.
+ [星战前夜](https://developers.eveonline.com/) - EVE Online is one of the most popular science fiction massively multiplayer online role-playing games (MMORPG). The EVE Online CREST and XML APIs provide programmatic access to characters, industries, markets, solar system, alliances and corporations, and other game data.
...
+ [Dingtalk](https://open-doc.dingtalk.com/) - Access to Dingtalk's APIs.
...
### 外卖
+ [百度外卖](http://dev.waimai.baidu.com/) - 百度外卖是中国一个外卖平台.
+ [大众点评](http://developer.dianping.com) - 大众点评是中国一个外卖平台.
+ [饿了么](http://openapi.eleme.io/v2/quickstart.html) - Eleme is a Chinese takeout platform.
+ [美团](http://developer.waimai.meituan.com/doc/show) - Meituan is a Chinese takeout platform.
...
+ [Worktile](https://dev.worktile.com/document/overview) - Access to Worktile's APIs.
...
### 翻译
+ [百度翻译](http://api.fanyi.baidu.com/api/trans/product/index) - Supports translation between multiple languages.
...
+ [金山词霸](http://open.iciba.com/?c=api) - Support simple translation.
...
+ [牛津词典](https://developer.oxforddictionaries.com/) - Access to Oxford Dictionaries' APIs.
+ [扇贝](https://www.shanbay.com/help/developer/api_v1/) - Provides complete APIs which support users in query, adding study records, writing note, etc.
...
+ [爱奇艺](http://open.iqiyi.com/lib/scheme.html) - Supports query data of iqiyi.
+ [乐视视频](http://www.lecloud.com/zh-cn/help/2016/07/27/150.html?LeftMenu=api_db_guide) - Allows to query data, upload, download, etc.
